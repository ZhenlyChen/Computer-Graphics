...
void Transformation::prepare() {
  ...
  unsigned char* data =
      stbi_load("Transformation/assets/mmexport1476440125120.jpg", &width,
                &height, &nrChannels, 0);
  if (data) {
    // ��������
  ...
  cudeShader = new Shader("Transformation/glsl/cube.vs.glsl",
                          "Transformation/glsl/cube.fs.glsl");
  cudeShader->Use();
...
void Transformation::render() {
  ...
  view = glm::lookAt(glm::vec3(0.0f, 2.0f, -6.0f), glm::vec3(0.0f, 0.0f, 0.0f),
                     glm::vec3(0.0f, 1.0f, 0.0f));
  projection = glm::perspective(
      glm::radians(45.0f),
      (float)this->defaultWidth / (float)this->defaultHeight, 0.1f, 100.0f);
  ...
  0.5f)); cudeShader->SetMat4("model", model);
  ...
  // ImGui ����
  {
    ...
    if (en_translation) {
      ...
      ImGui::SliderFloat("t x", &translation.x, -1.0f, 1.0f);
      ImGui::SameLine();
      ImGui::SliderFloat("t y", &translation.y, -1.0f, 1.0f);
      ImGui::SameLine();
    ...
    if (en_rotate) {
      ...
      ImGui::PushItemWidth(120);
      ImGui::SliderFloat("r x", &rotate.x, -1.0f, 1.0f);
      ImGui::SameLine();
      ImGui::SliderFloat("r y", &rotate.y, -1.0f, 1.0f);
      ImGui::SameLine();
    ...
    if (en_scale) {
      ...
      ImGui::PushItemWidth(120);
      ImGui::SliderFloat("s x", &scale.x, -3.0f, 3.0f);
      ImGui::SameLine();
      ImGui::SliderFloat("s y", &scale.y, -3.0f, 3.0f);
      ImGui::SameLine();
